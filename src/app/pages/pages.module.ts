...
@NgModule({
  declarations: [ DashboardComponent, ProductsComponent, InputDetailComponent, OutputDetailComponent, ProfileAdminComponent, CategoriesComponent, ProviderComponent, NewProviderComponent],
